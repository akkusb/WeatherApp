...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Bagel/Bagel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BagelCore/BagelCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CocoaAsyncSocket/CocoaAsyncSocket.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KeyboardDismisser/KeyboardDismisser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVProgressHUD/SVProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ScrollTo/ScrollTo.framework"
